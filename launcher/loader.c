...
int main(int argc, char * argv[])
{
    ...
    if ((error = dlerror()) == NULL) {
        ...
        jclass cls = (*env)->FindClass(env, "com/maccasoft/propeller/Loader");
...
#ifdef __linux__
extern unsigned char loader16_png[];
extern unsigned int loader16_png_len;

extern unsigned char loader32_png[];
extern unsigned int loader32_png_len;

extern unsigned char loader48_png[];
extern unsigned int loader48_png_len;
...
static const char * base_name = "maccasoft-proploader";
...
void install_desktop_launcher()
{
    ...
    snprintf(tempdir, sizeof(tempdir), "%s/propeller-firmware-loader-XXXXXX", ptr);
    ...
    fwrite(loader16_png, loader16_png_len, 1, fp);
    fclose(fp);
...
void uninstall_desktop_launcher()
{
    ...
    rc = system("/usr/bin/xdg-desktop-menu uninstall propeller-firmware-loader.desktop");
    rc = system("/usr/bin/xdg-icon-resource uninstall --context apps --size 16 propeller-firmware-loader.png");
    rc = system("/usr/bin/xdg-icon-resource uninstall --context apps --size 32 propeller-firmware-loader.png");
    rc = system("/usr/bin/xdg-icon-resource uninstall --context apps --size 48 propeller-firmware-loader.png");
    rc = system("/usr/bin/xdg-icon-resource uninstall --context apps --size 64 propeller-firmware-loader.png");
