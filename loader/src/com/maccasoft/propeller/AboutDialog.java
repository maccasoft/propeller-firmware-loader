...
public class AboutDialog extends Dialog {
    ...
    protected void configureShell(Shell newShell) {
        ...
        newShell.setText("About " + Loader.APP_TITLE);
    }
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        final String message = title + "\r\n" + "Copyright (c) 2025 Marco Maccaferri and others. All rights reserved.\r\n"
            + "\r\n"
        ...
        text.setCaret(null);
        text.setMargins(convertHorizontalDLUsToPixels(7), convertHorizontalDLUsToPixels(7), convertHorizontalDLUsToPixels(7), convertHorizontalDLUsToPixels(7));
